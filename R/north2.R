#' North symbol 2
#' @description Alternative implementation to add a north symbol to a ggplot map.
#' @param ggp ggplot2 object.
#' @param x number between 0 and 1 to indicate the x axis position of the symbol's bottomleft corner. 0 is the left side and 1 the right side.
#' @param y number between 0 and 1 to indicate the y axis position of the symbol's bottomleft corner. 0 is the bottom and 1 the top.
...
north2 <- function(ggp, x = 0.65, y = 0.9, scale = 0.1, symbol = 1) {
    ...
    inset <- qplot(0:1, 0:1, geom = "blank") + theme_bln() +
